...
import { AGROPAG_PHONE } from '@/lib/constants';

export default function FaqPage() {
  return (
    <MarketingScaffold whatsappMessage="Bonjour AGROPAG, j’ai une question FAQ.">
      <main className="max-w-4xl mx-auto px-4 py-12">
        <div className="text-center mb-12">
          <h1 className="text-3xl md:text-5xl font-black text-primary mb-4 tracking-tight">Foire Aux Questions</h1>
          <p className="text-slate-600 max-w-xl mx-auto">Tout ce que vous devez savoir sur les invendus AGROPAG, la vente au kilo et la livraison locale.</p>
        </div>
        ...
        <div className="space-y-4">
          {[
            ...
            ['D’où proviennent vos produits ?', 'De nos fermes, des invendus des marchés éphémères AGROPAG et de producteurs partenaires locaux.'],
          ].map(([q, a], idx) => (
        ...
        <div className="mt-16 bg-primary/5 border border-primary/20 rounded-xl text-center px-6 py-8">
          ...
          <p className="text-slate-600 mb-6 max-w-md mx-auto">Notre équipe est disponible pour vous aider.</p>
          <div className="flex flex-wrap justify-center gap-4">
            <a className="bg-primary text-white px-8 py-3 rounded-lg font-bold hover:bg-primary/90 transition-all flex items-center gap-2" href="mailto:info@agropag.ga">
              <span className="material-symbols-outlined">mail</span> Nous contacter (mailto:info@agropag.ga)
            </a>
            <a className="bg-white text-primary border border-primary/20 px-8 py-3 rounded-lg font-bold hover:bg-primary/5 transition-all flex items-center gap-2" href={`tel:011453040`}>
              <span className="material-symbols-outlined">call</span> 011453040
            </a>
            <a className="bg-white text-primary border border-primary/20 px-8 py-3 rounded-lg font-bold hover:bg-primary/5 transition-all flex items-center gap-2" href={`https://wa.me/24162560462`}>
              <span className="material-symbols-outlined">whatsapp</span> 062560462
            </a>
          </div>
        </div>
      </main>
