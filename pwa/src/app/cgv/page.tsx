...
import { AGROPAG_EMAIL } from '@/lib/constants';

export default function CgvPage() {
  return (
    <MarketingScaffold whatsappMessage="Bonjour AGROPAG, j’ai une question sur vos conditions et politiques.">
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="lg:w-3/4 space-y-16">
            <section>
              ...
              <p className="mt-4 text-lg text-slate-600 max-w-2xl">Dernière mise à jour: 26 février 2026. AGROPAG s’engage à la transparence sur ses services de vente au kilo, livraison et protection des données.</p>
            </section>

            <SectionBlock id="mentions" title="1. Mentions Légales">
              <p className="mb-4">Ce site est édité par <strong>AGROPAG (Societe agropastorale du Gabon)</strong>.</p>
              <ul className="space-y-4 list-none p-0">
                ...
                <li className="flex gap-4"><span className="material-symbols-outlined text-primary">mail</span><div><strong className="block">Email</strong> {AGROPAG_EMAIL}</div></li>
            ...
            <SectionBlock id="confidentialite" title="3. Politique de Confidentialité">
              <div className="bg-slate-50 p-8 rounded-2xl space-y-5">
                ...
                <div><h4 className="font-bold text-primary mb-2">Droits</h4><p className="text-sm">Demande d’accès, rectification ou suppression via support@agropag.ga.</p></div>
              </div>
            </SectionBlock>
            ...
            <SectionBlock id="livraison" title="4. Politique de Livraison et de Retour">
              <div className="space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {['Libreville', 'Akanda', 'Owendo', 'Ntoum'].map((zone) => (
