...
export const env = {
  ...
  webPushPublicKey: getFirstEnv(['NEXT_PUBLIC_WEB_PUSH_PUBLIC_KEY', 'WEB_PUSH_PUBLIC_KEY'], ''),
  webPushPrivateKey: getEnv('WEB_PUSH_PRIVATE_KEY', ''),
  webPushSubject: getEnv('WEB_PUSH_SUBJECT', 'mailto:commande@agropag.ga'),
  pushWebhookSecret: getEnv('AGROPAG_PUSH_WEBHOOK_SECRET', ''),
