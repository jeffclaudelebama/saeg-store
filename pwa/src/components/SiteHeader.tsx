          ...
          <div className="flex h-20 items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              <button
                ...
                className="inline-flex items-center rounded-lg bg-primary/5 px-3 py-2 text-sm text-slate-600"
                aria-label="Rechercher des produits"
              >
                <span className="material-symbols-outlined text-lg text-primary/60 sm:mr-2">search</span>
